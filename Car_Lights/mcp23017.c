...
void mcp23017_init(MCP23017 *obj, uint8_t address)
{
	...
	mcp23017_write_register(obj,MCP23017_IOCON,0x01);
	
//--	
	mcp23017_write_register(obj,MCP23017_IODIRA,0xFF);
	mcp23017_write_register(obj,MCP23017_IPOLA,0x00);
...
/*	obj->data = 0xFFFF;
	...
	obj->data = 0x0000;
	mcp23017_write_word(obj,MCP23017_IPOLA);*/
}
