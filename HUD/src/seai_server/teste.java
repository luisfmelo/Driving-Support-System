...
public class teste extends javax.swing.JFrame{
	...
	//private AudioInputStream inputStream = AudioSystem.getAudioInputStream(new File("/home/jose/workspace/HUD/src/Imagens/alarm.au"));
	...
	public void initialize() {
		...
		fadiga.setIcon(new ImageIcon("/home/jose/workspace/HUD/src/Imagens/coffee.png"));
		...
		inicial.setIcon(new ImageIcon("/home/jose/workspace/HUD/src/Imagens/car.png"));
		...
		lblTemperatura.setIcon(new ImageIcon("/home/jose/workspace/HUD/src/Imagens/temperature.png"));
		...
		lblVelocidade.setIcon(new ImageIcon("/home/jose/workspace/HUD/src/Imagens/speed.png"));
		...
		lblHumidade.setIcon(new ImageIcon("/home/jose/workspace/HUD/src/Imagens/humidity.png"));
		...
		data = new JLabel();
		data.setIcon(new ImageIcon("/home/jose/workspace/HUD/src/Imagens/clock1.png"));
		...
		labelLeft.setIcon(new ImageIcon("/home/jose/workspace/HUD/src/Imagens/arrowLeft.png"));
		...
		labelRight.setIcon(new ImageIcon("/home/jose/workspace/HUD/src/Imagens/arrowRight.png"));
		...
		labelGelo.setIcon(new ImageIcon("/home/jose/workspace/HUD/src/Imagens/ice.png"));
		...
		labelSun = new JLabel();
		labelSun.setIcon(new ImageIcon("/home/jose/workspace/HUD/src/Imagens/sun.png"));
		...
		labelMoon.setIcon(new ImageIcon("/home/jose/workspace/HUD/src/Imagens/moon.png"));
		...
		labelRainyDay.setIcon(new ImageIcon("/home/jose/workspace/HUD/src/Imagens/RainyDay.png"));
		...
		labelRainyNight.setIcon(new ImageIcon("/home/jose/workspace/HUD/src/Imagens/RainyNight.png"));
		...
		labelHeart.setIcon(new ImageIcon("/home/jose/workspace/HUD/src/Imagens/heartbeat.png"));
		...
		labelAuto.setIcon(new ImageIcon("/home/jose/workspace/HUD/src/Imagens/auto.png"));
		...
		labelManual.setIcon(new ImageIcon("/home/jose/workspace/HUD/src/Imagens/manual.png"));
		...
		button.setIcon(new ImageIcon("/home/jose/workspace/HUD/src/Imagens/power-button-off.png"));
	...
	ItemListener itemListener = new ItemListener() {
	    public void itemStateChanged(ItemEvent itemEvent) {
	        ...
	        if (state == ItemEvent.SELECTED) {
	            ...
	            button.setIcon(new ImageIcon("/home/jose/workspace/HUD/src/Imagens/power.png"));
	            //setFadiga(false);
	            selected=true;
	        } else {
...
/*	public void  playAlarm(boolean f)
	{
		 try {
		Clip myclip = AudioSystem.getClip();
		//String alarmFile = "C:/Users/Amandio/workspace/hudgui/img/alarm.au";
	   // InputStream in = new FileInputStream(alarmFile);
        AudioInputStream inputStream = AudioSystem.getAudioInputStream(new File("/home/jose/workspace/HUD/src/Imagens/alarm.au"));
        myclip.open(inputStream);
        if (f==true && myclip.isActive()==false)	
        	{
        	//myclip.start();
        ...
        else //myclip != null && myclip.isActive() && f==false)
        	{
        	System.out.print("\nstop clip\n");
	...
	public void playAlarm(boolean p)
	{
		try {
	        ...
	        //player.Sound(new File("/home/jose/workspace/HUD/src/Imagens/alarm.au"));
	        myclip.start();
       		System.out.print("\n" + "toca");
	        //if(p == false && myclip.isRunning()){
	...
	/*public void changeFadiga(boolean f) {
		if (!f){
			tired = false;
			fadiga.setVisible(false);
			inicial.setVisible(true);
			...
			fadiga.setText("Cuidado! Precisa de Descansar!");
	...
	public void changeLeft(boolean l) {
		//ImageIcon ice = new ImageIcon("/home/jose/workspace/HUD/src/Imagens/ice-crystal.png");
		if (!l){
			left = false;
			labelLeft.setVisible(false);
		}
