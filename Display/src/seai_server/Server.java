...
public class Server {
	 ...
	 * Server > java Server portNumber If the port number is not specified 5000
	 * is used
	 */
			...
			while (keepGoing) {
				...
				if (s.contains("-")) {
					...
					for (int i = 0; /* parts[i]!=null && !parts[i].isEmpty() */i <= (parts.length - 1); i++) {
						...
						// if(String.valueOf(buffer[0]).equals("c") &&
						// String.valueOf(buffer[1]).equals("2")){
						...
						if (part.startsWith("T") && part != null && !part.isEmpty()) {
							...
							// temperature = String.valueOf(buffer[6]) +
							// String.valueOf(buffer[7])+
							// String.valueOf(buffer[8]);
				...
				String w = w2 + w1;
				if ((!String.valueOf(w).equals("ds")) && (!String.valueOf(w).equals("dr"))
						&& (!String.valueOf(w).equals("ns")) && (!String.valueOf(w).equals("nr"))) {
				...
				if (String.valueOf(buffer[0]).equals("O")) {
					if (String.valueOf(buffer[1]).equals("0") || String.valueOf(buffer[1]).equals("1")
							|| String.valueOf(buffer[1]).equals("2"))
				...
				/*
				 * if(real_speed >= 70){ fadigaState = true;
				 * System.out.print("\n" + "entra no ciclo\n"); }
				 */
				...
				if (fadigaState) {
					...
					if ((velocidade == 0 || velocidade == 1 || velocidade == 2)
							&& String.valueOf(olhosstate).equals("0") && String.valueOf(pedalstate).equals("2")
							&& String.valueOf(volantestate).equals("0") && String.valueOf(w1).equals("r")
						...
						System.out.print("\n" + "liga 0" + SuperGui.getFadigaState());
							...
							&& String.valueOf(olhosstate).equals("0") && String.valueOf(pedalstate).equals("2")
							&& String.valueOf(volantestate).equals("0") && String.valueOf(w2).equals("n")) {
						...
						System.out.print("\n" + "liga 1" + SuperGui.getFadigaState());
							...
							&& String.valueOf(olhosstate).equals("1") && String.valueOf(pedalstate).equals("2")
						...
						System.out.print("\n" + "liga 2" + SuperGui.getFadigaState());
							...
							String.valueOf(olhosstate).equals("1") && String.valueOf(pedalstate).equals("2")
							&& String.valueOf(volantestate).equals("1") && String.valueOf(w1).equals("r")
							&& String.valueOf(w2).equals("d")) {
						...
						System.out.print("\n" + "liga 3" + SuperGui.getFadigaState());
							...
							&& String.valueOf(olhosstate).equals("1") && String.valueOf(pedalstate).equals("2")
							&& String.valueOf(volantestate).equals("1") && String.valueOf(w1).equals("s")
							&& String.valueOf(w2).equals("d") && SuperGui.getGeloState()) {
						...
						System.out.print("\n" + "liga 4" + SuperGui.getFadigaState());
							...
							&& String.valueOf(volantestate).equals("1") && String.valueOf(w1).equals("s")
							&& String.valueOf(w2).equals("d") 
							&& (linhas == "esq" || linhas == "dir")) {

						SuperGui.setFadiga(true);

						// SuperGui.playAlarm(true);
						System.out.print("\n" + "liga 4.5" + SuperGui.getFadigaState());
					}
						...
						System.out.print("\n" + "liga 5" + SuperGui.getFadigaState());
							...
							&& String.valueOf(olhosstate).equals("1") && String.valueOf(pedalstate).equals("1")
							&& String.valueOf(volantestate).equals("0") && String.valueOf(w1).equals("r")
							&& String.valueOf(w2).equals("d")) {
						...
						System.out.print("\n" + "liga 6" + SuperGui.getFadigaState());
							...
							&& String.valueOf(olhosstate).equals("1") && String.valueOf(pedalstate).equals("1")
							&& String.valueOf(volantestate).equals("0") && String.valueOf(w1).equals("s")
							&& String.valueOf(w2).equals("d") && SuperGui.getGeloState()) {
						...
						// SuperGui.playAlarm(true);
						System.out.print("\n" + "liga 7.5" + SuperGui.getFadigaState());
					}
						...
						System.out.print("\n" + "liga " + SuperGui.getFadigaState());
							...
							&& String.valueOf(pedalstate).equals("1") && String.valueOf(volantestate).equals("1")
							&& String.valueOf(w1).equals("r") && String.valueOf(w2).equals("d")
						...
						System.out.print("\n" + "liga 4.5" + SuperGui.getFadigaState());
							...
							&& String.valueOf(olhosstate).equals("1")
							&& String.valueOf(pedalstate).equals("1") && String.valueOf(volantestate).equals("1")
							&& String.valueOf(w1).equals("s") && String.valueOf(w2).equals("d")
							&& SuperGui.getGeloState()) {
						...
						// SuperGui.playAlarm(true);
						System.out.print("\n" + "liga 11.5" + SuperGui.getFadigaState());
					}
						...
						System.out.print("\n" + "liga 12" + SuperGui.getFadigaState());
							...
							&& String.valueOf(olhosstate).equals("1") && String.valueOf(pedalstate).equals("1")
							&& String.valueOf(volantestate).equals("1") && String.valueOf(w1).equals("s")
							&& String.valueOf(w2).equals("n") && SuperGui.getGeloState()) {
					...
					else if ((velocidade == 1 || velocidade == 2) && String.valueOf(olhosstate).equals("1")
							&& String.valueOf(pedalstate).equals("1") && String.valueOf(volantestate).equals("1")
							&& String.valueOf(w1).equals("s") && String.valueOf(w2).equals("n")
							&& !SuperGui.getGeloState()) {
						...
						// SuperGui.playAlarm(true);
						System.out.print("\n" + "liga 14.5" + SuperGui.getFadigaState());
					}

					else if ((velocidade == 0 || velocidade == 1 || velocidade == 2)
							&& String.valueOf(olhosstate).equals("1") && String.valueOf(pedalstate).equals("0")
							&& String.valueOf(volantestate).equals("0") && String.valueOf(w1).equals("r")
							&& String.valueOf(w2).equals("d") && SuperGui.getGeloState()) {
						...
						System.out.print("\n" + "liga 15" + SuperGui.getFadigaState());
							...
							&& String.valueOf(pedalstate).equals("0") && String.valueOf(volantestate).equals("0")
							&& String.valueOf(w1).equals("r") && String.valueOf(w2).equals("d")
							&& !SuperGui.getGeloState()) {
					...
					else if (velocidade == 2 && String.valueOf(olhosstate).equals("1")
							&& String.valueOf(pedalstate).equals("0") && String.valueOf(volantestate).equals("0")
							&& String.valueOf(w1).equals("s") && String.valueOf(w2).equals("d")
							&& SuperGui.getGeloState()) {
						...
						// SuperGui.playAlarm(true);
						System.out.print("\n" + "liga 17.5" + SuperGui.getFadigaState());
					}
				...
				if (String.valueOf(buffer).equals("exit")) {
					// System.out.println("Client " + Integer.toString(id) + "
					// disconected");
					keepGoing = false;
				}
				count += 1000;
