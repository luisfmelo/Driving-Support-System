/* DHT library
 MIT license
 this library was based on the Adafruit Industries dhtxx library which supports AM2302
 
 modified by cactus.io
 this library only supports the AM2302.
 */

#include "cactus_io_AM2302.h"

AM2302::AM2302(uint8_t pin, uint8_t count) {
    _pin = pin;
    _count = count;
    firstreading = true;
}

void AM2302::begin(void) {
    // set up the pins!
    pinMode(_pin, INPUT);
...
void AM2302::readTemperature(void) {
...
float AM2302::computeHeatIndex_C(void) {
...
float AM2302::computeHeatIndex_F(void) {
